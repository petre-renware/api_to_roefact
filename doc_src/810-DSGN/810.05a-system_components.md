...
Facilitatile si functionalitatile generale (pe scurt) ale fiecareia din acestea sunt prezentate mai jos. (Pentru intelegerea facilitatilor unei componente a se citi sectiunea [xxx...](xxx...))  <!--#TODO: these are subject to check ref implemented features -->
