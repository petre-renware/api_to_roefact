...
def rdinv(
    ...
    *,
    ...
    Args:
        ...
        `debug_info`: ordered list with all print messages issued by function. If None or nothing sent will print on `stdout`. List is required because a mutable object is needed to be able to write in.
    ...
    * `ws: pylightxl object`: WORKSHEET object with invoice
    ...
    console = Console(prev_stdout)  # restore stdout
