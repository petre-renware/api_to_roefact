...
def xl2json(
    ...
    #... use `glob.glob()` as here `https://docs.python.org/2/library/glob.html` ...OR...
    #... use Path.glob() as example in file `./example_use_Path.glob.py` ...
    #... processing is like for RENware invoice && Kraftanlagen invoice (next code lines, #100..#105):
