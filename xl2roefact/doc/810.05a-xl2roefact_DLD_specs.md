...
* [rdinv](#rdinv)
  ...
  * [PATTERN\_FOR\_PARTNER\_ADDRESS\_COUNTRY](#rdinv.PATTERN_FOR_PARTNER_ADDRESS_COUNTRY)
  * [PATTERN\_FOR\_PARTNER\_ADDRESS\_CITY](#rdinv.PATTERN_FOR_PARTNER_ADDRESS_CITY)
  * [PATTERN\_FOR\_PARTNER\_ADDRESS\_STREET](#rdinv.PATTERN_FOR_PARTNER_ADDRESS_STREET)
  * [PATTERN\_FOR\_PARTNER\_ADDRESS\_ZIPCODE](#rdinv.PATTERN_FOR_PARTNER_ADDRESS_ZIPCODE)
  * [rdinv](#rdinv.rdinv)
...
* [\_\_version\_\_](#__version__)
  * [\_\_version\_\_](#__version__.__version__)
...
def xl2json(
    ...
    files_directory: Annotated[
        ...
        typer.Option(
            ...
            "-d",
            exists=
            True,  #TODO `def_inv_dir` issue - this constraint should be dropped as will consider just if directory exists, otherwise will use `./` (current dir)
            file_okay=False,
            dir_okay=True,
            writable=True,
            readable=True,
...
<a id="rdinv.PATTERN_FOR_PARTNER_ADDRESS_COUNTRY"></a>

#### PATTERN\_FOR\_PARTNER\_ADDRESS\_COUNTRY

FIXME @240115 info line, can drop, drop me after compiling test

<a id="rdinv.PATTERN_FOR_PARTNER_ADDRESS_CITY"></a>

#### PATTERN\_FOR\_PARTNER\_ADDRESS\_CITY

FIXME @240115 info line, can drop, drop me after compiling test

<a id="rdinv.PATTERN_FOR_PARTNER_ADDRESS_STREET"></a>

#### PATTERN\_FOR\_PARTNER\_ADDRESS\_STREET

FIXME @240115 info line, can drop, drop me after compiling test

<a id="rdinv.PATTERN_FOR_PARTNER_ADDRESS_ZIPCODE"></a>

#### PATTERN\_FOR\_PARTNER\_ADDRESS\_ZIPCODE
