...
Regulile recomandate se gasessc in documentul (recommended rules are in document) [`data/README_app_config_rules.md`](../xl2roefact/data/README_app_config_rules.md)
