...
* wip... 231109piu_b #TODO invoice lines, then isolate header and footer ==> set variable for these zones: `invoice_header_area`, `invoice_lines_area`, `invoice_footer_area`
