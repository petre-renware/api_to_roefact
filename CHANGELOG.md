...
* wip... `240228piu01` created a mechanism to run adhoc commands *for xl2roefact component*:
    ...
    * [ ] 3. workflow `adhoc-run.yml` to install pdm environment & run pdm script (ref step 1) triggered by merge to branch `adhoc`. Run results (stdout and stderr) written to `./tests/_test_results.txt`
