...
* 2402208piu_a updated `xl2roefact library` documentation and docstrings to clarify subjects by using specific technical terms (this component address technical users not business ones)
