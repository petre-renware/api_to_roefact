...
* `cbc_DueDate` search `invoice_header_area` ref `PATTERN_FOR_DUE_DATE` pattern. Get found data if relevant or default it as `invoice_header_area["issued_date"]["value": "2023-08-28"] + DUE_DATE_DAYS` if `None` found
