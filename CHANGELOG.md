...
* 240208piu_a updated `xl2roefact library` documentation, docstrings and `mkdocs.yml` navigation entries to clarify subjects by using specific technical terms (this component address technical users not business ones)
